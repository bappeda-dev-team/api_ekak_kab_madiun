...
func (controller *IsuNasionalControllerImpl) FindAll(writer http.ResponseWriter, request *http.Request, params httprouter.Params) {

	kodeOpd := params.ByName("kode_opd")

	bidangUrusanResponses, err := controller.IsuNasionalService.FindAll(request.Context(), kodeOpd)
	if err != nil {
		webResponse := web.WebResponse{
...
func (controller *IsuNasionalControllerImpl) FindByIds(writer http.ResponseWriter, request *http.Request, params httprouter.Params) {

	findRequest := isunasional.FindByIdsRequest{}
	helper.ReadFromRequestBody(request, &findRequest)

	response, err := controller.IsuNasionalService.FindByIds(request.Context(), findRequest)
	if err != nil {
