...
func (controller *IsuKlhsControllerImpl) FindAll(writer http.ResponseWriter, request *http.Request, params httprouter.Params) {

	kodeOpd := params.ByName("kode_opd")

	bidangUrusanResponses, err := controller.IsuKlhsService.FindAll(request.Context(), kodeOpd)
	if err != nil {
		webResponse := web.WebResponse{
...
func (controller *IsuKlhsControllerImpl) FindByIds(writer http.ResponseWriter, request *http.Request, params httprouter.Params) {

	findRequest := isuklhs.FindByIdsRequest{}
	helper.ReadFromRequestBody(request, &findRequest)

	response, err := controller.IsuKlhsService.FindByIds(request.Context(), findRequest)
	if err != nil {
