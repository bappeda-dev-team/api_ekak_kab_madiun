...
type IsuNasionalResponse struct {
	ID               int       `json:"id"`
...
type IsuNasionalFullResponse struct {
	ID               int		`json:"id"`
	KodeOpd 		 string		`json:"kode_opd"`
...
type IsuNasionalMasterResponse struct {
	BidangUrusanSelections []BidangUrusanSelectionResponse `json:"bidang_urusan_selections"`
	Isus                   []IsuNasionalFullResponse               `json:"isu_nasionals"`
}