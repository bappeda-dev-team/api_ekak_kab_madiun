...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/sasaran_opd/rankhir/{sasaran_opd_id}/indikator": {
            "put": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "description": "Memperbarui data sasaran opd rankhir yang sudah ada berdasarkan ID.",
                "consumes": [
                    "application/json"
                ],
                "produces": [
                ...
                "summary": "Upsert Sasaran Opd Rankhir",
                "parameters": [
                    {
                        "type": "integer",
                        "example": 1,
                    ...
                    {
                        "description": "Payload Upsert Sasaran OPD",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
        ...
        "/sasaran_opd/ranwal/{sasaran_opd_id}/indikator": {
            "put": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "description": "Memperbarui data sasaran opd ranwal yang sudah ada berdasarkan ID.",
                "consumes": [
                    "application/json"
                ],
                "produces": [
                ...
                "summary": "Upsert Sasaran Opd Ranwal",
                "parameters": [
                    {
                        "type": "integer",
                        "example": 1,
        ...
        "/sasaran_opd/renstra/{sasaran_opd_id}/indikator": {
            "put": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "description": "Memperbarui data sasaran opd renstra yang sudah ada berdasarkan ID.",
                "consumes": [
                    "application/json"
                ],
                "produces": [
                ...
                "summary": "Upsert Sasaran Opd Renstra",
                "parameters": [
                    {
                        "type": "integer",
                        "example": 1,
