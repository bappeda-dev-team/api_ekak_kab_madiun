...
var taggingPokinSet = wire.NewSet(repository.NewTaggingPokinRepositoryImpl, wire.Bind(new(repository.TaggingPokinRepository), new(*repository.TaggingPokinRepositoryImpl)), service.NewTaggingPokinServiceImpl, wire.Bind(new(service.TaggingPokinService), new(*service.TaggingPokinServiceImpl)), controller.NewTaggingPokinControllerImpl, wire.Bind(new(controller.TaggingPokinController), new(*controller.TaggingPokinControllerImpl)))
